...
public class MoveBehaviour : GenericBehaviour
{
	...
	void Update ()
	{
        ...
        if (!attack && Input.GetButtonDown("Fire1") && behaviourManager.IsCurrentBehaviour(this.behaviourCode) && !behaviourManager.IsOverriding())
        {
            attack = true;
        }
    }
    ...
    {
        // Start a new jump.
        if (attack && !behaviourManager.GetAnim.GetBool(attackBool) && behaviourManager.IsGrounded())
        {
            // Set jump related parameters.
            behaviourManager.LockTempBehaviour(this.behaviourCode);
        ...
        // Is already jumping?
        else if (behaviourManager.GetAnim.GetBool(attackBool))
        {
